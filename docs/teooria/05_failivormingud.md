# Osa 5 - Sertifikaadi failivormingud

## Sama sisu, erinevad pakendid

Kui hakkad sertifikaatidega tööle, kohtad peagi failinimede džunglit: .pem, .crt, .cer, .key, .p12, .pfx, .der, .jks... See tundub alguses kaosena, aga tegelikult on loogika olemas.
...
PEM on nagu sertifikaatide lingua franca. Kui avad PEM-faili tekstiredaktoris, näed midagi sellist:
