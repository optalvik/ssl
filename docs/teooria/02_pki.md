...
# Mis on PKI ehk avaliku võtme infrastruktuur?

<figure markdown="span">
  ![PKI komponendid](../assets/PKI.png)
  <figcaption>Joonis 2.1. Avaliku võtme infrastruktuuri (PKI) komponendid (Talvik, 2025). Loodud NotebookLM abil.</figcaption>
</figure>
...
Siin tulevad mängu sertifikaadid. Sertifikaat on nagu digitaalne pass[^rfc5280] - see sisaldab avalikku võtit, infot selle kohta, kellele see kuulub, ja kõige olulisem - kellegi usaldusväärse allkirja.
...
Tipus on juur-CA. Selle võtit hoitakse üliturvalises kohas, sageli võrguväliselt. Juur-CA allkirjastab vahe-CA-d, kes omakorda allkirjastavad lõppsertifikaate.[^ristic] Kui sinu brauser saab sertifikaadi, kontrollib ta kogu ahelat: kas server-sertifikaat on allkirjastatud vahe-CA poolt? Kas vahe-CA on allkirjastatud juur-CA poolt? Kas juur-CA on brauseri usaldatud nimekirjas?
...
PKI lahendab usalduse probleemi internetis. Avaliku ja privaatvõtme paarid võimaldavad turvalist suhtlust, sertifikaadid tõestavad identiteeti ja sertifitseerimisasutused (CA) on usalduse ankrud. Usaldusahel ühendab juur-CA, vahe-CA ja serveri sertifikaadi ühtseks kontrollitavaks ketiks.

---

## Enesekontroll

??? question "1. Mis on PKI ja millist probleemi see lahendab?"
    PKI (Public Key Infrastructure) on süsteem, mis võimaldab veebisaitidel ja serveritel tõestada oma identiteeti. See lahendab usalduse probleemi - kuidas teada, et server, millega räägid, on tõesti see, kes ta väidab end olevat.

??? question "2. Mis vahe on avalikul ja privaatvõtmel?"
    Avalikku võtit võib jagada kõigile - sellega saab krüpteerida ja allkirju kontrollida. Privaatvõtit hoitakse ainult enda teada - sellega saab dekrüpteerida ja allkirjastada. Need töötavad matemaatilise paarina.

??? question "3. Mis on sertifitseerimisasutus (CA) ja miks me neid usaldame?"
    CA (Certificate Authority) on organisatsioon, kes allkirjastab sertifikaate ja kinnitab, et avalik võti kuulub õigele omanikule. Me usaldame CA-sid, sest nad peavad järgima rangeid reegleid ja läbima auditeid. Brauserid eemaldavad CA-d nimekirjast, kui nad reegleid rikuvad.

??? question "4. Mis on usaldusahel ja miks see oluline on?"
    Usaldusahel on hierarhia: juur-CA allkirjastab vahe-CA, vahe-CA allkirjastab serveri sertifikaadi. Brauser kontrollib kogu ahelat ülespoole kuni juur-CA-ni. Kui üks lüli on katki (aegunud, vale allkiri, tundmatu CA), ühendust ei usaldata.
